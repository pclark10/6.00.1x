...
def buildCoder(shift):
    ...
    for i in range(len(string.ascii_uppercase)):
        ltr = string.ascii_uppercase[i]
        try:
            x = string.ascii_uppercase[i+shift]
        except IndexError:
            x = string.ascii_uppercase[(i-26)+shift]
        alpha[ltr] = x
    for i in range(len(string.ascii_lowercase)):
        ltr = string.ascii_lowercase[i]
        try:
            x = string.ascii_lowercase[i+shift]
        except IndexError:
